...
|---|---|---|
| `ts/` | @voxgig-sdk/viacep-address-lookup-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/viacep-address-lookup-sdk \
      --repository voxgig-sdk/viacep-address-lookup-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/viacep-address-lookup-sdk` shows it, and
`npm trust revoke @voxgig-sdk/viacep-address-lookup-sdk --id=<id>` removes it.
