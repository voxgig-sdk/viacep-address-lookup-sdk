...
// ViacepAddressLookup SDK utility type

class ViacepAddressLookupUtility
{
    ...
    public static function copy(ViacepAddressLookupUtility $src): ViacepAddressLookupUtility
    {
        $u = new ViacepAddressLookupUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
