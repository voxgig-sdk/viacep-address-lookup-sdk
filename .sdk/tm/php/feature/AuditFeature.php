...
// ViacepAddressLookup SDK audit feature
...
class ViacepAddressLookupAuditFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _emit(ViacepAddressLookupContext $ctx, string $outcome): void
    {
