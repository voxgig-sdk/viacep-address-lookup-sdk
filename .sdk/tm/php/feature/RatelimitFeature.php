...
// ViacepAddressLookup SDK ratelimit feature
...
class ViacepAddressLookupRatelimitFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _acquire(ViacepAddressLookupContext $ctx): void
    {
    ...
    private function _track(ViacepAddressLookupContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
