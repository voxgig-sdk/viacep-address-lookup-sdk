...
// ViacepAddressLookup SDK timeout feature
...
class ViacepAddressLookupTimeoutFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _with_timeout(ViacepAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ViacepAddressLookupContext $_ctx, float $ms): void
    {
        $client = $this->client;
