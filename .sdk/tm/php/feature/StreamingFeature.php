...
// ViacepAddressLookup SDK streaming feature
...
class ViacepAddressLookupStreamingFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _iterate(ViacepAddressLookupResult $result): \Generator
    {
    ...
    private function _streamable(ViacepAddressLookupContext $ctx): bool
    {
