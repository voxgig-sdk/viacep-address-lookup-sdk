...
// ViacepAddressLookup SDK utility: fetcher

class ViacepAddressLookupFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ViacepAddressLookupSDK/1.0)';
    ...
    public static function call(ViacepAddressLookupContext $ctx, string $fullurl, array $fetchdef): array
    {
