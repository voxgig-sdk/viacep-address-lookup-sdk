...
// ViacepAddressLookup SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ViacepAddressLookupMakeRequest
{
    public static function call(ViacepAddressLookupContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ViacepAddressLookupResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ViacepAddressLookupResponse($fetched);
        } else {
