...
from projectname_sdk.core.control import ViacepAddressLookupControl
...
class ViacepAddressLookupContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ViacepAddressLookupControl()
        ...
        if isinstance(sp, ViacepAddressLookupSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ViacepAddressLookupResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ViacepAddressLookupResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ViacepAddressLookupOperation({})
        ...
        op = ViacepAddressLookupOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return ViacepAddressLookupError(code, msg, self)
