...
class ViacepAddressLookupTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ViacepAddressLookupTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ViacepAddressLookupTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ViacepAddressLookupTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
