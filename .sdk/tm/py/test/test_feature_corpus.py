# ViacepAddressLookup SDK feature corpus test
#
...
def _client(kase):
    ...
    ViacepAddressLookupSDK(...), not ViacepAddressLookupSDK.test(...): the `test` feature is
    ...
    return ViacepAddressLookupSDK(opts)
