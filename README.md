...
ViaCEP is a free web service that allows users to query Brazilian postal codes (CEPs) and retrieve address information in JSON or XML format.

Learn more about ViaCEP Address Lookup at [viacep.com.br](https://viacep.com.br).
