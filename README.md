...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/viacep-address-lookup` | `npm install @voxgig-sdk/viacep-address-lookup` |
| Python | `voxgig-sdk-viacep-address-lookup` | `pip install voxgig-sdk-viacep-address-lookup` |
| PHP | `voxgig-sdk/viacep-address-lookup` | `composer require voxgig-sdk/viacep-address-lookup` |
| Golang | `github.com/voxgig-sdk/viacep-address-lookup-sdk/go` | `go get github.com/voxgig-sdk/viacep-address-lookup-sdk/go` |
| Ruby | `voxgig-sdk-viacep-address-lookup` | `gem install voxgig-sdk-viacep-address-lookup` |
| Lua | `voxgig-sdk-viacep-address-lookup` | `luarocks install voxgig-sdk-viacep-address-lookup` |
