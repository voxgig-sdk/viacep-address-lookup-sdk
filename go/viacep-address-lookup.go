...
// instead of `sdk.NewViacepAddressLookupSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ViacepAddressLookupSDK  { return NewViacepAddressLookupSDK(nil) }
func Test() *ViacepAddressLookupSDK { return TestSDK(nil, nil) }
