...
type CepLookupEntity struct {
	name    string
	client  *core.ViacepAddressLookupSDK
...
func NewCepLookupEntity(client *core.ViacepAddressLookupSDK, entopts map[string]any) *CepLookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CepLookupEntity) GetName() string { return e.name }
...
func (e *CepLookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CepLookupEntity) Deleted() bool {
	return e.deleted
}


func (e *CepLookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCepLookupEntity(e.client, opts)
}

func (e *CepLookupEntity) Data(args ...any) any {
...
func (e *CepLookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CepLookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CepLookupEntity) DataTyped(data ...CepLookup) CepLookup {
	if len(data) > 0 {
		return typedFrom[CepLookup](e.Data(asMap(data[0])))
	}
	return typedFrom[CepLookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CepLookup (all fields
// optional at the wire level).
func (e *CepLookupEntity) MatchTyped(match ...CepLookup) CepLookup {
	if len(match) > 0 {
		return typedFrom[CepLookup](e.Match(asMap(match[0])))
	}
	return typedFrom[CepLookup](e.Match())
}
...
func (e *CepLookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CepLookupEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CepLookupLoadMatch and returns an CepLookup. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CepLookupEntity) LoadTyped(reqmatch CepLookupLoadMatch, ctrl map[string]any) (CepLookup, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CepLookup{}, err
	}
	return typedFrom[CepLookup](res), nil
}



func (e *CepLookupEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CepLookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CepLookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CepLookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CepLookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
