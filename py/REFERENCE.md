# ViacepAddressLookup Python SDK Reference

Complete API reference for the ViacepAddressLookup Python SDK.
...
#### `ViacepAddressLookupSDK.test(testopts=None, sdkopts=None)`
...
Create a new `CepLookupEntity` instance. Pass `None` for no initial data.
...
Create a new `CepLookupEntity` instance with the same options.
