...
from viacepaddresslookup_sdk.utility import register

# Load features
from viacepaddresslookup_sdk.feature.base_feature import ViacepAddressLookupBaseFeature
from viacepaddresslookup_sdk.features import _has_feature, _make_feature
...
class ViacepAddressLookupSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ViacepAddressLookupUtility()
        self._utility = utility

        from viacepaddresslookup_sdk.config import shared_config
    ...
    def get_utility(self):
        return ViacepAddressLookupUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ViacepAddressLookupSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def CepLookup(self, data=None) -> "CepLookupEntity":
        ...
        from viacepaddresslookup_sdk.entity.cep_lookup_entity import CepLookupEntity
