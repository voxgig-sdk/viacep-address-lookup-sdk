# ViacepAddressLookup Python SDK



The Python SDK for the ViacepAddressLookup API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.CepLookup()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/viacep-address-lookup-sdk/releases)) or
...
```
py/
├── viacepaddresslookup_sdk.py         -- Main SDK module
...
The main module (`viacepaddresslookup_sdk`) exports the SDK class.
