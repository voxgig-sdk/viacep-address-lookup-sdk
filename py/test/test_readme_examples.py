# ViacepAddressLookup SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ViacepAddressLookupSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ViacepAddressLookupSDK(...) and ViacepAddressLookupSDK.test(...) become
#      ViacepAddressLookupSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "viacepaddresslookup_sdk"
_SDK_CLASS = "ViacepAddressLookupSDK"
