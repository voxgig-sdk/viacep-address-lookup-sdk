...
class ViacepAddressLookupSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ViacepAddressLookupHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ViacepAddressLookupHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ViacepAddressLookupFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ViacepAddressLookupFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ViacepAddressLookupUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ViacepAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ViacepAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ViacepAddressLookupHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ViacepAddressLookupError($op . "_allow",
                "ViacepAddressLookupSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ViacepAddressLookupHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ViacepAddressLookupError("graphql_error",
                "ViacepAddressLookupSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function CepLookup($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_cep_lookup === null) {
                $this->_cep_lookup = new CepLookupEntity($this, null);
            }
            return $this->_cep_lookup;
        }
        return new CepLookupEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ViacepAddressLookupSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
