...
// ViacepAddressLookup SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ViacepAddressLookupSDK::test)
...
{
    private const SDK_CLASS = 'ViacepAddressLookupSDK';
    ...
    private const SDK_BASE = 'viacepaddresslookup_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../viacepaddresslookup_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
