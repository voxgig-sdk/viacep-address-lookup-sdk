...
// ViacepAddressLookup SDK utility: graphql
//
...
class ViacepAddressLookupGraphql
{
    ...
    // equivalent.
    public static function body(ViacepAddressLookupContext $ctx): mixed
    {
    ...
    public static function errors(ViacepAddressLookupContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
