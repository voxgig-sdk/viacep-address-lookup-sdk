...
// ViacepAddressLookup SDK idempotency feature
...
class ViacepAddressLookupIdempotencyFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _mutating(ViacepAddressLookupContext $ctx): bool
    {
