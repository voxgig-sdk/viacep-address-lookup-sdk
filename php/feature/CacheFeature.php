...
// ViacepAddressLookup SDK cache feature
...
class ViacepAddressLookupCacheFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _through(ViacepAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
