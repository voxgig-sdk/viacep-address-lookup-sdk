...
// ViacepAddressLookup SDK telemetry feature
...
class ViacepAddressLookupTelemetryFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _close(ViacepAddressLookupContext $ctx, bool $ok): void
    {
