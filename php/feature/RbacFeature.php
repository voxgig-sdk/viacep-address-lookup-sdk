...
// ViacepAddressLookup SDK rbac feature
...
class ViacepAddressLookupRbacFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _required(ViacepAddressLookupContext $ctx): ?string
    {
    ...
    private function _reject(ViacepAddressLookupContext $ctx, string $required): void
    {
    ...
    private function _track(ViacepAddressLookupContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
