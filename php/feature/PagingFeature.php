...
// ViacepAddressLookup SDK paging feature
...
class ViacepAddressLookupPagingFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _is_list(ViacepAddressLookupContext $ctx): bool
    {
