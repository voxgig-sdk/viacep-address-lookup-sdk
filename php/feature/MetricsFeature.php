...
// ViacepAddressLookup SDK metrics feature
...
class ViacepAddressLookupMetricsFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _record(ViacepAddressLookupContext $ctx, bool $ok): void
    {
