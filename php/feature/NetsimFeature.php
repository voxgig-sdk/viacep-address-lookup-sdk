...
// ViacepAddressLookup SDK netsim feature
...
class ViacepAddressLookupNetsimFeature extends ViacepAddressLookupBaseFeature
{
    ...
    private function _simulate(ViacepAddressLookupContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ViacepAddressLookupContext $ctx, array $applied): void
    {
        $client = $this->client;
