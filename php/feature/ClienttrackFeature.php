...
// ViacepAddressLookup SDK clienttrack feature
...
class ViacepAddressLookupClienttrackFeature extends ViacepAddressLookupBaseFeature
{
    ...
    public function PostConstruct(ViacepAddressLookupContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ViacepAddressLookup-SDK';
