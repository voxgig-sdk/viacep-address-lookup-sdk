...
// ViacepAddressLookup SDK proxy feature
...
class ViacepAddressLookupProxyFeature extends ViacepAddressLookupBaseFeature
{
    ...
    public function init(ViacepAddressLookupContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ViacepAddressLookupContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
