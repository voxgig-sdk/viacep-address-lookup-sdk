...
local CepLookupEntity = {}
CepLookupEntity.__index = CepLookupEntity


function CepLookupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CepLookupEntity)
  self._name = "cep_lookup"
  self._client = client
...
function CepLookupEntity:get_name()
  return self._name
end


function CepLookupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CepLookupEntity.new(self._client, opts)
end
...
function CepLookupEntity:mark_deleted()
  self._deleted = true
end


function CepLookupEntity:deleted()
  return true == self._deleted
end


function CepLookupEntity:data_set(args)
  if args ~= nil then
...
function CepLookupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CepLookupEntity:match_set(args)
  if args ~= nil then
...
function CepLookupEntity:match_get()
...
function CepLookupEntity:stream(action, args, callopts)
...
---@param reqmatch CepLookupLoadMatch
---@param ctrl? table
---@return CepLookup
---@return string? err
function CepLookupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CepLookupEntity:_run_op(ctx, post_done)
  local utility = self._utility
