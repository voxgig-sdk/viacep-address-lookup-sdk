# ViacepAddressLookup Lua SDK Reference

Complete API reference for the ViacepAddressLookup Lua SDK.
...
```lua
local result, err = client:CepLookup(nil):load({ id = "cep_lookup_id" }, nil)
```
