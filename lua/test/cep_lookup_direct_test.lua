...
describe("CepLookupDirect", function()
  it("should direct-load-cep_lookup", function()
    local setup = cep_lookup_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cep_lookup", setup.live and "live" or "unit")
...
function cep_lookup_direct_setup(mockres)
