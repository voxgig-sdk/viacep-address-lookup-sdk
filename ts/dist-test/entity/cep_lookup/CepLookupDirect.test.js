...
(0, node_test_1.describe)('CepLookupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ViacepAddressLookupSDK({
    ...
    (0, node_test_1.test)('direct-load-cep_lookup', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-cep_lookup', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ViacepAddressLookupSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['VIACEP_ADDRESS_LOOKUP_TEST_CEP_LOOKUP_ENTID'];
    ...
    const client = new __1.ViacepAddressLookupSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CepLookupDirect.test.js.map