...
func registerSDKWords(r *eng.Registry, client *sdk.ViacepAddressLookupSDK) {
...
func runOp(client *sdk.ViacepAddressLookupSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
