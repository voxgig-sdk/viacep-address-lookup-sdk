...
#      offline in seeded test mode (ViacepAddressLookupSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ViacepAddressLookup_sdk.rb")
  SDK_CLASS = "ViacepAddressLookupSDK"
  ...
  SDK_BASE = "ViacepAddressLookup_sdk"
