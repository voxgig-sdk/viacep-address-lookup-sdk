// Command ViacepAddressLookup-mcp is an MCP server exposing the ViacepAddressLookup
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ViacepAddressLookup_list  — list records of an entity
//	ViacepAddressLookup_load  — load a single record of an entity
//
