...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cep_lookup"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ViacepAddressLookupSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "viacep-address-lookup_list",
		Description: "List records from ViacepAddressLookup. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "viacep-address-lookup_load",
		Description: "Load a single record from ViacepAddressLookup. " +
...
func runOp(client *sdk.ViacepAddressLookupSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ViacepAddressLookupSDK, name string) (sdk.ViacepAddressLookupEntity, error) {
	switch strings.ToLower(name) {
	case "cep_lookup":
		return client.CepLookup(nil), nil
